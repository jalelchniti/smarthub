        ...
        <div className="relative w-full px-4 sm:px-6 lg:px-8 text-center">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link to="/register">
                <Button size="lg" className="flex items-center space-x-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-12 py-6 text-xl rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-200">
